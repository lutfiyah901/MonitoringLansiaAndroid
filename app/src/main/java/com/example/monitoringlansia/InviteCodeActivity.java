...
public class InviteCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference().child("user_gambar");
    ...
    {
        progressDialog.setMessage("Tunggu Sebentar Ya .. Kita Sedang Membuat Akun Untukmu");
        progressDialog.show();
                            ...
                            reference.child(userId).setValue(createUser)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                //nyimpen gambar ng firebase data basse
                                                                            ...
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                    if (task.isSuccessful())
                                                                                    {
                                                                                        ...
                                                                                        //Toast.makeText(getApplicationContext(), "Email dikirim untuk verifikasi.Cek Email !",Toast.LENGTH_LONG).show();
                                                                                        ...
                                                                                        progressDialog.dismiss();
                                                                                        Toast.makeText(getApplicationContext(), "eror ketika membuat akun",Toast.LENGTH_SHORT).show();
                                                ...
                                                Toast.makeText(getApplicationContext(), " Tidak Bisa Register ", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        }
        ...
        user.sendEmailVerification()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            Toast.makeText(getApplicationContext(),"email dikirim untuk verifikasi",Toast.LENGTH_SHORT).show();
                            finish();
                            auth.signOut();
                        }
                        else
